...
class ClienteFilter(django_filters.FilterSet):
    ...
    estado = django_filters.ChoiceFilter(choices=Cliente.estados, widget=forms.Select(attrs={'class':'form-control'}))
...
class ProfesorFilter(django_filters.FilterSet):
    ...
    email = django_filters.CharFilter(lookup_expr='icontains', widget=forms.TextInput(attrs={'class':'form-control'}))
    dni = django_filters.CharFilter(lookup_expr='icontains', widget=forms.TextInput(attrs={'class':'form-control'}))
    titulo_habilitante = django_filters.CharFilter(lookup_expr='icontains', widget=forms.TextInput(attrs={'class':'form-control'}))
    institucion_habilitante = django_filters.CharFilter(lookup_expr='icontains', widget=forms.TextInput(attrs={'class':'form-control'}))
