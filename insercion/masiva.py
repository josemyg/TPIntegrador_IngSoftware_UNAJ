from insercion.clientes import crear_clientes
from insercion.profesores import crear_profesores_argentinos
#from .profesores_y_clientes import crear_muchos_profesores, crear_muchos_clientes
from insercion.canchas import create_stadiums
from insercion.clases_y_entrenamientos import crear_clases_entrenamientos
from insercion.equipos import create_teams
